...
class CategoryTransitionWidget extends StatefulWidget {
  ...
  const CategoryTransitionWidget({super.key, required this.isHighlight, required this.duration, required this.imagePath});

  @override
  State<CategoryTransitionWidget> createState() => _CategoryTransitionWidgetState();
}

class _CategoryTransitionWidgetState extends State<CategoryTransitionWidget> with TickerProviderStateMixin {
    ...
    return ScaleTransition(
      ...
      child: Center(
        child: Image.asset(
          ...
          // floor() pega o int abaixo do numero double
          color: Color.fromARGB(255, 255, 255, (255 * (imageColorAnimationController.value - 1).abs()).floor()),
        ),
      ),
    );
  }
